...
release: code/versioncheck.sh
	...
	tar --exclude="abi2dsurqec_Composite.h5" --exclude="dsurqe_labels.csv" --exclude="*15*obj" --exclude="*40*nii" --exclude="*20*nii" -hcJf releases/mouse-brain-templatesHD-${VERSION}.tar.xz mouse-brain-templates/
